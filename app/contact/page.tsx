...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with Heidy De La Cruz to discuss your content journey. Book a complimentary consultation or reach out directly.",
};
        ...
        <section className="pt-16 pb-4 lg:pt-20 lg:pb-6 bg-white text-center">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-lg lg:text-xl text-gray-700 max-w-2xl mx-auto mb-6">
              Whether you&apos;re a business looking to amplify your brand or a
              coach exploring new marketing strategies, I&apos;m here to help
              you get started.
            </p>
        ...
        <section className="py-10 lg:py-14 bg-white">
          <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center space-y-6">
            <p className="text-lg lg:text-xl text-gray-700 leading-relaxed">
              Are you a business looking to amplify your brand and increase
              service awareness?
            </p>
            <p className="text-lg lg:text-xl text-gray-700 leading-relaxed">
              Or perhaps you&apos;re a coach aiming to elevate your business and
              explore innovative marketing strategies?
            </p>
            <p className="text-lg lg:text-xl text-gray-700 leading-relaxed">
              Look no further! I&apos;m Heidy, and I&apos;m here to guide you
              through the simple and effective process of launching your
              podcast.
            </p>
          </div>
        </section>
            ...
            <div className="grid sm:grid-cols-2 gap-10 max-w-2xl mx-auto">
              ...
              <div className="bg-white rounded-lg p-10 shadow-sm flex flex-col items-center gap-6">
                ...
                <div>
                  ...
                  <Button
                    href="https://calendly.com/heidydelacruz13"
                    size="md"
                    target="_blank"
